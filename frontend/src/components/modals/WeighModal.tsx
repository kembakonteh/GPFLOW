  ...
  const waHref = (() => {
    ...
    if (showConsolidated) {
      ...
      msg =
        ...
        `Package refs:\n${pkgList}\n\n` +
        `Booking ref: ${ref}\n\n` +
        `Please forward these to ${b.recipient_name} in ${b.recipient_city} so they can show them when collecting.\n\n` +
        `— ${op} via GPFLOW`;
    } else {
      msg =
          ...
          <>
            ...
            {isMailingApplicable && (
              <div style={{
                ...
                <span>Mailing cost will be entered after USPS/UPS visit</span>
              </div>
            )}
